    ...
    if (allphone.length == 0) {
        ...
        <div class="card h-100 " style="border-radius:10px">
            ...
            <div class="card-body">
                ...
                <button  onclick="more('${phone.slug}')" data-bs-toggle="modal" data-bs-target="#modal" type="button" class="btn btn-success"> More Details
                </button>                
            </div>
        </div>`;
...
const moreDetils = phone => {
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <img src="${phone.data.image}" class="card-img-fluid p-5 m-5" alt="...">
